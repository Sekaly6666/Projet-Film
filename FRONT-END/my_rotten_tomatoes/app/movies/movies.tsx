    ...
    return (
      <main className="min-vh-100 bg-dark text-white d-flex align-items-center justify-content-center">
        <p className="italic text-secondary">
          Aucun film disponible dans la base MongoDB.
        </p>
      </main>
    );
  }
...
=======
  const selectedMovie =
    allMovies.find((movie) => movie._id === currentMovieId) ?? allMovies[0];
>>>>>>> origin/search
  ...
  return (
    <main className="min-vh-100 bg-dark text-white position-relative">
      <div
        ...
        style={{ zIndex: 1100, marginTop: "90px" }}
      >
        <div
          className={`toast align-items-center text-white bg-danger border-0 shadow ${showToast ? "show" : "hide"}`}
          role="alert"
        >
          <div className="d-flex">
            <div className="toast-body d-flex align-items-center gap-2">
              ...
              <span>
                Connexion requise ! Vous devez être connecté pour voir les
                détails d'un film.
              </span>
            </div>
            <button
              ...
              <div className="col-12 col-lg-8">
                ...
                <div className="my-4">
                  <div className="mb-2 text-light">
                    ...
                    {selectedMovie.release_date || "Inconnue"}
                  </div>
                  <div className="mb-2 text-light">
                    <strong>Note TMDB :</strong>{" "}
                    {selectedMovie.vote_average?.toFixed(1) ?? "0"}/10
                  </div>
                </div>
                <div className="d-flex flex-wrap gap-3">
                  <a
                    href="#"
                    onClick={(e) => isAuthenticated(e, "#")}
...
>>>>>>> origin/search
          ...
          <div className="pt-5 text-center my-5 py-5 border border-secondary rounded bg-black bg-opacity-25">
            ...
            <p className="text-secondary col-md-6 mx-auto">
              Vous devez créer un compte ou vous connecter pour accéder aux
              fiches détaillées, regarder ou télécharger les films.
            </p>
            <Link
              href="/login"
              className="btn btn-danger fw-bold px-4 py-2 mt-2"
            >
              ...
              <div key={movie._id} className="col-12 col-sm-6 col-lg-3">
                ...
                >
                  ...
                  <div className="card-body">
                    <h2 className="card-title fs-6 fw-bold mb-2">
                      {movie.title}
                    </h2>
