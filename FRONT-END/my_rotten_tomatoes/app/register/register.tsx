...
export default function RegisterPage() {
  return (
    <main
      ...
      className="min-vh-100 d-flex align-items-center justify-content-center px-3 py-5 text-white" style={{  backgroundImage: `  linear-gradient(90deg, rgba(16, 16, 20, 0.9), rgba(16, 16, 20, 0.55)), url("https://image.tmdb.org/t/p/original/1pdfLvkbY9ohJlCjQH2CZjjYVvJ.jpg") `, backgroundPosition: "center", backgroundSize: "cover", }}>
      ...
      <section className="w-100 rounded-3 p-4 p-md-5 bg-dark bg-opacity-75" style={{ maxWidth: "430px" }} >
        ...
        <p className="text-light">
          Creer un compte pour commenter, noter et garder vos films preferes.
        </p>

        <form className="d-flex flex-column gap-3 mt-4">
          <div>
            <label htmlFor="name" className="form-label fw-bold">   Nom</label>
            <input id="name" type="text" placeholder="Votre nom" className="form-control bg-black text-white border-secondary py-3"/>
          </div>
          ...
          <button type="submit" className="btn btn-danger fw-bold py-3">  S'inscrire </button>
        </form>
